...
export const InitialGameState: Game = {
  ...
  unusedTokens: [
    ...
    { id: "B1", type: "bag", name: "Bag Slot 2", player: 1 },
    { id: "B2", type: "bag", name: "Bag Slot 2", player: 1 },
    { id: "B3", type: "bag", name: "Bag Slot 3", player: 1 },
    { id: "B4", type: "bag", name: "Bag Slot 4", player: 1 },
    { id: "B5", type: "bag", name: "Bag Slot 5", player: 1 },
    { id: "B6", type: "bag", name: "Bag Slot 6", player: 1 },
    { id: "B7", type: "bag", name: "Bag Slot 7", player: 1 },
    { id: "B8", type: "bag", name: "Bag Slot 8", player: 1 },
  ...
  lockedPlaces: [
    {
      ...
      tokens: [],
      actions: [
        { consume: ["T", "T"], produce: ["I1"], needs: ["L2"] },
    ...
    },
    {
      ...
      tokens: [],
      actions: [
        { consume: ["T", "T"], produce: ["I3"], needs: ["L3"] },
    ...
    },
    {
      ...
      tokens: [],
      actions: [
        { consume: ["T", "T"], produce: ["I1"], needs: ["L4"] },
